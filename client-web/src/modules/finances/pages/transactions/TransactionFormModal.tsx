...
// Transaction kinds the user can enter manually (transfers have their own flow;
// statement payments and transfer legs are generated by the backend).
    ...
    >
      <Form form={form} layout="vertical" onFinish={handleSubmit}>
        <Form.Item name="target" label={t('finances.transactions.target')}>
          <Radio.Group
            onChange={() => {
              // The kind set changes with the target; reset to a valid default.
