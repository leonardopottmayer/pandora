...
/// <summary>
/// Generates opaque password-reset tokens and derives the hash that is persisted.
/// The plaintext token travels only in the reset e-mail; the database keeps just its SHA-256.
/// </summary>
