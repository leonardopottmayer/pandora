...
/// <summary>
/// One-time, time-boxed token that authorizes a password reset (forgot-password flow).
...
public sealed class PasswordResetToken
{
    ...
    public static PasswordResetToken Issue(Guid userId, string tokenHash, DateTimeOffset expiresAt)
        => new()
        {
