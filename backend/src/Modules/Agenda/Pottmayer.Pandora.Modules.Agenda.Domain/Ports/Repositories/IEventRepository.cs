...
public interface IEventRepository : IStandardRepository<Event, Guid>
{
    ...
    /// <summary>
    /// Live events of the user whose series could overlap <c>[from, to]</c> â€” the range-query scan root.
    ...
    /// <summary>
    /// Live, recurring or single events by id, across users â€” the sweep resolves the subjects of the
