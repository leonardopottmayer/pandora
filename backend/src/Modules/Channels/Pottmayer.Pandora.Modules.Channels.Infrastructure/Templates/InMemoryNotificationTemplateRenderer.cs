...
/// <summary>
/// Renders templates from code, localized to en / pt-BR. A file-based catalogue is a future step;
/// keeping templates in code (versioned in git) is the minimum.
/// </summary>
public sealed class InMemoryNotificationTemplateRenderer(IOptions<ChannelsOptions> options)
